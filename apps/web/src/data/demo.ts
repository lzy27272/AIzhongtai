...
export const demoExpectations: WorkExpectation[] = [
  { id: 'we-1', title: '杭州中心店OTA巡查', packageName: 'OTA每日运营巡查', itemName: '评分与差评检查', status: 'PENDING', businessDate: '2026-07-17', dueAt: '2026-07-17T18:00:00+08:00', targetOrgName: '杭州中心店', hotelOrgUnitId: '12000000-0000-0000-0000-000000000003', hotelName: '杭州中心店', departmentName: '市场销售部', positionJobFamily: 'SALES_MARKETING', assigneeName: '唐悦' },
  { id: 'we-2', title: '上海滨江店OTA巡查', packageName: 'OTA每日运营巡查', itemName: '价格与房态检查', status: 'SUBMITTED', businessDate: '2026-07-17', dueAt: '2026-07-17T18:00:00+08:00', targetOrgName: '上海滨江店', hotelOrgUnitId: '12000000-0000-0000-0000-000000000004', hotelName: '上海滨江店', departmentName: '市场销售部', positionJobFamily: 'SALES_MARKETING', assigneeName: '唐悦', recordId: 'record-demo-ota', evaluationOutcome: 'WARNING', standards: [{ standardVersionId: 'standard-version-ota', usageType: 'EXECUTION', standardCode: 'STD-OTA-REVIEW', title: 'OTA评价巡查标准', versionNo: 1 }] },
  { id: 'we-3', title: '前台早班交接', packageName: '前台班次工作包', itemName: 'VIP与客诉交接', status: 'OVERDUE', businessDate: '2026-07-17', dueAt: '2026-07-17T10:00:00+08:00', targetOrgName: '杭州中心店', hotelOrgUnitId: '12000000-0000-0000-0000-000000000003', hotelName: '杭州中心店', departmentName: '前厅部', positionJobFamily: 'FRONT_DESK', assigneeName: '林悦' },
  { id: 'we-4', title: '前厅班组检查', packageName: '前厅主管每日管理', itemName: '人员状态与服务检查', status: 'COMPLETED', businessDate: '2026-07-17', targetOrgName: '杭州中心店 · 前厅部', hotelOrgUnitId: '12000000-0000-0000-0000-000000000003', hotelName: '杭州中心店', departmentName: '前厅部', positionJobFamily: 'FRONT_DESK', assigneeName: '陈航', recordId: 'record-demo-front', evaluationOutcome: 'PASS', standards: [{ standardVersionId: 'standard-version-front', usageType: 'EXECUTION', standardCode: 'STD-FO-DAILY', title: '前厅主管每日检查标准', versionNo: 1 }] },
  { id: 'we-5', title: '12层客房卫生巡检', packageName: '客房主管每日巡检', itemName: '客房清洁与设施检查', status: 'SUBMITTED', businessDate: '2026-07-17', dueAt: '2026-07-17T16:00:00+08:00', targetOrgName: '杭州中心店 · 客房部', hotelOrgUnitId: '12000000-0000-0000-0000-000000000003', hotelName: '杭州中心店', departmentName: '客房部', positionJobFamily: 'HOUSEKEEPING', assigneeName: '周敏', recordId: 'record-demo-housekeeping', evaluationOutcome: 'WARNING', standards: [{ standardVersionId: 'standard-version-housekeeping', usageType: 'ACCEPTANCE', standardCode: 'STD-HK-INSPECTION', title: '客房卫生检查标准', versionNo: 1 }] },
]
