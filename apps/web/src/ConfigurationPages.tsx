...
function Modal({ title, children, onClose, onSave, saving, saveLabel = '保存', saveDisabled = false, wide = false }: { title: string; children: React.ReactNode; onClose: () => void; onSave: () => void; saving: boolean; saveLabel?: string; saveDisabled?: boolean; wide?: boolean }) {
  return <div className="modal-backdrop"><section className={`modal configuration-modal ${wide ? 'work-package-editor-modal' : ''}`} role="dialog" aria-modal="true">
